...
IL_0083_1:
			{
				...
				NullCheck(L_20);
				VirtualActionInvoker0::Invoke(19 /* System.Void System.IO.Stream::Close() */, L_20);
			}
...
IL_00b9_1:
			...
			}
			{
				...
				NullCheck(L_23);
				VirtualActionInvoker0::Invoke(13 /* System.Void System.Threading.WaitHandle::Close() */, L_23);
