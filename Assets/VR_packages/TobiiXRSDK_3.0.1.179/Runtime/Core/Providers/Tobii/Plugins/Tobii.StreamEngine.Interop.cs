...
namespace Tobii.StreamEngine
{
    ...
    [StructLayout(LayoutKind.Sequential)]
    public struct tobii_lens_configuration_extented_per_eye_t
    {
    ...
    {
        public tobii_lens_configuration_extented_per_eye_t left;
        public tobii_lens_configuration_extented_per_eye_t right;
    }
